...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength65Plus(byte[] bytes, int offset, int length) {
        ...
        while (true) {
            long[] v2 = v;
            long x2 = Long.rotateRight(x + z + v[0] + LittleEndianByteArray.load64(bArr, offset2 + 8), 37) * K1;
            long y = Long.rotateRight(v2[1] + z + LittleEndianByteArray.load64(bArr, offset2 + 48), 42) * K1;
            long x3 = x2 ^ w[1];
            long y2 = y + v2[0] + LittleEndianByteArray.load64(bArr, offset2 + 40);
            long z4 = Long.rotateRight(w[0] + z3, 33) * K1;
            weakHashLength32WithSeeds(bytes, offset2, v2[1] * K1, x3 + w[0], v2);
            weakHashLength32WithSeeds(bytes, offset2 + 32, z4 + w[1], y2 + LittleEndianByteArray.load64(bArr, offset2 + 16), w);
            x = z4;
            long z5 = x3;
            offset2 += 64;
            if (offset2 == end) {
                long mul = ((255 & z5) << 1) + K1;
                ...
                long j = mul;
                return hashLength16(hashLength16(v2[0], w[0], j) + (shiftMix(y3) * K0) + x4, hashLength16(v2[1], w[1], j) + z6, j);
            }
            int i3 = last64offset;
            z3 = z5;
            v = v2;
