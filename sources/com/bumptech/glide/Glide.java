...
public class Glide implements ComponentCallbacks2 {
    ...
    Glide(Context context, Engine engine2, MemoryCache memoryCache2, BitmapPool bitmapPool2, ArrayPool arrayPool2, RequestManagerRetriever requestManagerRetriever2, ConnectivityMonitorFactory connectivityMonitorFactory2, int logLevel, RequestOptionsFactory defaultRequestOptionsFactory2, Map<Class<?>, TransitionOptions<?, ?>> defaultTransitionOptions, List<RequestListener<Object>> defaultRequestListeners, boolean isLoggingRequestOriginsEnabled, boolean isImageDecoderEnabledForBitmaps) {
        ...
        this.registry.append(ByteBuffer.class, new ByteBufferEncoder()).append(InputStream.class, new StreamEncoder(arrayPool3)).append(Registry.BUCKET_BITMAP, ByteBuffer.class, Bitmap.class, byteBufferBitmapDecoder).append(Registry.BUCKET_BITMAP, InputStream.class, Bitmap.class, streamBitmapDecoder);
        ...
        ResourceDecoder<ByteBuffer, Bitmap> byteBufferBitmapDecoder2 = byteBufferBitmapDecoder;
        ...
        ResourceDecoder<ByteBuffer, Bitmap> resourceDecoder3 = byteBufferBitmapDecoder2;
        ...
        ByteBufferGifDecoder byteBufferGifDecoder4 = byteBufferGifDecoder3;
        ...
        GlideContext glideContext3 = new GlideContext(context, arrayPool2, registry3, imageViewTargetFactory, defaultRequestOptionsFactory2, defaultTransitionOptions, defaultRequestListeners, engine2, isLoggingRequestOriginsEnabled, logLevel);
