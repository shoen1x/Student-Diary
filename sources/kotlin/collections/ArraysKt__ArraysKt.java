                                                    ...
                                                    if (!(v1 instanceof UByteArray) || !(v2 instanceof UByteArray)) {
                                                        if (!(v1 instanceof UShortArray) || !(v2 instanceof UShortArray)) {
                                                            if (!(v1 instanceof UIntArray) || !(v2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m483contentEqualsus8wMrg(((ULongArray) v1).m279unboximpl(), ((ULongArray) v2).m279unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m480contentEqualsctEhBpI(((UIntArray) v1).m210unboximpl(), ((UIntArray) v2).m210unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m482contentEqualsmazbYpA(((UShortArray) v1).m374unboximpl(), ((UShortArray) v2).m374unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m481contentEqualskdPth3s(((UByteArray) v1).m141unboximpl(), ((UByteArray) v2).m141unboximpl())) {
                                                        return false;
                                                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] $this$contentDeepToStringInternal, StringBuilder result, List<Object[]> processed) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (element == null) {
                ...
                result.append(UArraysKt.m489contentToStringGBYM_sE(((UByteArray) element).m141unboximpl()));
            } else if (element instanceof UShortArray) {
                result.append(UArraysKt.m491contentToStringrL5Bavg(((UShortArray) element).m374unboximpl()));
            } else if (element instanceof UIntArray) {
                result.append(UArraysKt.m488contentToStringajY9A(((UIntArray) element).m210unboximpl()));
            } else if (element instanceof ULongArray) {
                result.append(UArraysKt.m490contentToStringQwZRm1k(((ULongArray) element).m279unboximpl()));
            } else {
