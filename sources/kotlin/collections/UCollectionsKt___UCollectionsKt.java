...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> $this$toUByteArray) {
        ...
        byte[] result = UByteArray.m126constructorimpl($this$toUByteArray.size());
        int index = 0;
        for (UByte r3 : $this$toUByteArray) {
            UByteArray.m137setVurrAj0(result, index, r3.m124unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> $this$toUIntArray) {
        ...
        int[] result = UIntArray.m195constructorimpl($this$toUIntArray.size());
        int index = 0;
        for (UInt r3 : $this$toUIntArray) {
            UIntArray.m206setVXSXFK8(result, index, r3.m193unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> $this$toULongArray) {
        ...
        long[] result = ULongArray.m264constructorimpl($this$toULongArray.size());
        int index = 0;
        for (ULong r3 : $this$toULongArray) {
            ULongArray.m275setk8EXiF4(result, index, r3.m262unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> $this$toUShortArray) {
        ...
        short[] result = UShortArray.m359constructorimpl($this$toUShortArray.size());
        int index = 0;
        for (UShort r3 : $this$toUShortArray) {
            UShortArray.m370set01HTLdE(result, index, r3.m357unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> $this$sum) {
        ...
        for (UInt r2 : $this$sum) {
            sum = UInt.m150constructorimpl(sum + r2.m193unboximpl());
        }
        return sum;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> $this$sum) {
        ...
        for (ULong r3 : $this$sum) {
            sum = ULong.m219constructorimpl(sum + r3.m262unboximpl());
        }
        return sum;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> $this$sum) {
        ...
        for (UByte r2 : $this$sum) {
            sum = UInt.m150constructorimpl(UInt.m150constructorimpl(r2.m124unboximpl() & 255) + sum);
        }
        return sum;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> $this$sum) {
        ...
        for (UShort r2 : $this$sum) {
            sum = UInt.m150constructorimpl(UInt.m150constructorimpl(65535 & r2.m357unboximpl()) + sum);
        }
        return sum;
    }
}
