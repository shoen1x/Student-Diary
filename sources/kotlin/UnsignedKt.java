...
public final class UnsignedKt {
    ...
    public static final int m376uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m150constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        if (v <= d) {
            return UInt.m150constructorimpl((int) v);
        }
        return UInt.m150constructorimpl(UInt.m150constructorimpl((int) (v - d)) + UInt.m150constructorimpl(Integer.MAX_VALUE));
    }
