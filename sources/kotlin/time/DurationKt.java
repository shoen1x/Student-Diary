...
public final class DurationKt {
    ...
    public static final double toDuration(double $this$toDuration, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m11constructorimpl(DurationUnitKt.convertDurationUnit($this$toDuration, unit, TimeUnit.NANOSECONDS));
    }
    ...
    private static final double m56timesmvk6XK0(int $this$times, double duration) {
        return Duration.m38timesimpl(duration, $this$times);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m55timeskIfJnKk(double $this$times, double duration) {
        return Duration.m37timesimpl(duration, $this$times);
    }
}
