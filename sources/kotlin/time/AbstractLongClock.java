...
public abstract class AbstractLongClock implements Clock {
    ...
    private static final class LongClockMark extends ClockMark {
        ...
        public ClockMark m5plusLRDsOJo(double duration) {
            return new LongClockMark(this.startedAt, this.clock, Duration.m35plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }
    }
