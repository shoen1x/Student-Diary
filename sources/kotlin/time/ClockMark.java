...
public abstract class ClockMark {
    ...
    public ClockMark m8plusLRDsOJo(double duration) {
        return new AdjustedClockMark(this, duration, (DefaultConstructorMarker) null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public ClockMark m7minusLRDsOJo(double duration) {
        return m8plusLRDsOJo(Duration.m52unaryMinusimpl(duration));
    }

    public final boolean hasPassedNow() {
        return !Duration.m32isNegativeimpl(elapsedNow());
    }
