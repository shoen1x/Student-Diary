...
public final class UStringsKt {
    ...
    public static final String m1toStringLxnNnR4(byte $this$toString, int radix) {
    ...
    public static final String m3toStringolVBNx4(short $this$toString, int radix) {
    ...
    public static final String m2toStringV7xB4Y4(int $this$toString, int radix) {
    ...
    public static final String m0toStringJSWoG40(long $this$toString, int radix) {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m124unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m357unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m262unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m193unboximpl();
        if (UnsignedKt.uintCompare(r0, UInt.m150constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m77boximpl(UByte.m83constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m193unboximpl();
        if (UnsignedKt.uintCompare(r0, UInt.m150constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m310boximpl(UShort.m316constructorimpl((short) r0));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m150constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m150constructorimpl(result * uradix);
            int beforeAdding = result2;
            result = UInt.m150constructorimpl(UInt.m150constructorimpl(digit) + result2);
            if (UnsignedKt.uintCompare(result, beforeAdding) < 0) {
                return null;
            }
        }
        return UInt.m144boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        while (i2 < length) {
            ...
            result = ULong.m219constructorimpl(ULong.m219constructorimpl(((long) UInt.m150constructorimpl(digit)) & 4294967295L) + result2);
