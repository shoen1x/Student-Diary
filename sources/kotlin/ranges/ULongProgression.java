...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step2) {
        if (step2 == 0) {
            ...
            this.first = start;
            this.last = UProgressionUtilKt.m926getProgressionLastElement7ftBX0g(start, endInclusive, step2);
            this.step = step2;
        } else {
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m256toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m256toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m943fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
