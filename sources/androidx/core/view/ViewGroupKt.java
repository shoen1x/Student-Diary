...
public final class ViewGroupKt {
    public static final View get(ViewGroup $receiver, int index) {
        ...
        throw new IndexOutOfBoundsException("Index: " + index + ", Size: " + $receiver.getChildCount());
    }
    ...
    public static final void setMargins(ViewGroup.MarginLayoutParams $receiver, int size) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        $receiver.setMargins(size, size, size, size);
    }

    public static /* bridge */ /* synthetic */ void updateMargins$default(ViewGroup.MarginLayoutParams $receiver, int left, int top, int right, int bottom, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public static final void updateMargins(ViewGroup.MarginLayoutParams $receiver, int left, int top, int right, int bottom) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        $receiver.setMargins(left, top, right, bottom);
    }

    public static /* bridge */ /* synthetic */ void updateMarginsRelative$default(ViewGroup.MarginLayoutParams $receiver, int start, int top, int end, int bottom, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public static final void updateMarginsRelative(ViewGroup.MarginLayoutParams $receiver, int start, int top, int end, int bottom) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        $receiver.setMarginStart(start);
        $receiver.topMargin = top;
        $receiver.setMarginEnd(end);
