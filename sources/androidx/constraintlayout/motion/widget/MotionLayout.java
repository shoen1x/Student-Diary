...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
        ...
        MotionScene motionScene = this.mScene;
        if (motionScene != null) {
            MotionScene.Transition currentTransition = motionScene.mCurrentTransition;
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        int regionId;
        MotionScene motionScene = this.mScene;
        if (!(motionScene == null || !this.mInteractionEnabled || (currentTransition = motionScene.mCurrentTransition) == null || !currentTransition.isEnabled() || (touchResponse = currentTransition.getTouchResponse()) == null || (regionId = touchResponse.getTouchRegionId()) == -1)) {
