...
public class GPUImageRenderer implements GLSurfaceView.Renderer, Camera.PreviewCallback {
        ...
        if (this.mRunOnDraw.isEmpty()) {
            runOnDraw(new Runnable() {
                public void run() {
                    ...
                    int unused = gPUImageRenderer.mGLTextureId = OpenGlUtils.loadTexture(gPUImageRenderer.mGLRgbBuffer, previewSize, GPUImageRenderer.this.mGLTextureId);
    ...
    public void setUpSurfaceTexture(final Camera camera) {
        runOnDraw(new Runnable() {
            public void run() {
                ...
                SurfaceTexture unused = GPUImageRenderer.this.mSurfaceTexture = new SurfaceTexture(textures[0]);
                try {
    ...
    public void adjustImageScaling() {
        ...
        float ratioWidth = ((float) Math.round(((float) this.mImageWidth) * ratioMax)) / outputWidth;
        ...
        if (this.mScaleType == GPUImage.ScaleType.CENTER_CROP) {
            ...
            float[] fArr = CUBE;
            cube = new float[]{fArr[0] / ratioHeight, fArr[1] / ratioWidth, fArr[2] / ratioHeight, fArr[3] / ratioWidth, fArr[4] / ratioHeight, fArr[5] / ratioWidth, fArr[6] / ratioHeight, fArr[7] / ratioWidth};
        }
