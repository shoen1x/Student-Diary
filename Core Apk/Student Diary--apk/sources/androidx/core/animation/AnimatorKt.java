...
public final class AnimatorKt {
    public static final Animator.AnimatorListener doOnEnd(Animator $receiver, Function1<? super Animator, Unit> action) {
        ...
        $receiver.addListener(listener$iv);
        return listener$iv;
    }

    public static final Animator.AnimatorListener doOnStart(Animator $receiver, Function1<? super Animator, Unit> action) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(action, "action");
    ...
    public static final Animator.AnimatorListener doOnCancel(Animator $receiver, Function1<? super Animator, Unit> action) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(action, "action");
    ...
    public static final Animator.AnimatorListener doOnRepeat(Animator $receiver, Function1<? super Animator, Unit> action) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(action, "action");
    ...
    public static final Animator.AnimatorPauseListener doOnResume(Animator $receiver, Function1<? super Animator, Unit> action) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(action, "action");
        AnimatorKt$doOnResume$$inlined$addPauseListener$1 listener$iv = new AnimatorKt$doOnResume$$inlined$addPauseListener$1(action);
        $receiver.addPauseListener(listener$iv);
        return listener$iv;
    }

    public static final Animator.AnimatorPauseListener doOnPause(Animator $receiver, Function1<? super Animator, Unit> action) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(action, "action");
    ...
    public static /* bridge */ /* synthetic */ Animator.AnimatorListener addListener$default(Animator $receiver, Function1 onEnd, Function1 onStart, Function1 onCancel, Function1 onRepeat, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public static final Animator.AnimatorListener addListener(Animator $receiver, Function1<? super Animator, Unit> onEnd, Function1<? super Animator, Unit> onStart, Function1<? super Animator, Unit> onCancel, Function1<? super Animator, Unit> onRepeat) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(onEnd, "onEnd");
        Intrinsics.checkParameterIsNotNull(onStart, "onStart");
        Intrinsics.checkParameterIsNotNull(onCancel, "onCancel");
    ...
    public static /* bridge */ /* synthetic */ Animator.AnimatorPauseListener addPauseListener$default(Animator $receiver, Function1 onResume, Function1 onPause, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public static final Animator.AnimatorPauseListener addPauseListener(Animator $receiver, Function1<? super Animator, Unit> onResume, Function1<? super Animator, Unit> onPause) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(onResume, "onResume");
        Intrinsics.checkParameterIsNotNull(onPause, "onPause");
        AnimatorKt$addPauseListener$listener$1 listener = new AnimatorKt$addPauseListener$listener$1(onPause, onResume);
