...
public final class ViewKt {
    ...
    public static final Bitmap drawToBitmap(View $receiver, Bitmap.Config config) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
    ...
    public static final void updateLayoutParams(View $receiver, Function1<? super ViewGroup.LayoutParams, Unit> block) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(block, "block");
        View $receiver$iv = $receiver;
        ViewGroup.LayoutParams params$iv = $receiver$iv.getLayoutParams();
        if (params$iv != null) {
    ...
    private static final <T extends ViewGroup.LayoutParams> void updateLayoutParamsTyped(View $receiver, Function1<? super T, Unit> block) {
    ...
    public static final int getMarginStart(View $receiver) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        ViewGroup.LayoutParams lp = $receiver.getLayoutParams();
