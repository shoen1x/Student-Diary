        ...
        try {
            ...
            if (cursor2 != null && cursor2.getCount() > 0) {
                ...
                while (cursor2.moveToNext()) {
                    ...
                    result.add(new FontInfo(fileUri, ttcIndex, weightColumnIndex != -1 ? cursor2.getInt(weightColumnIndex) : LogSeverity.WARNING_VALUE, italicColumnIndex != -1 && cursor2.getInt(italicColumnIndex) == 1, resultCode));
                    i = 0;
                }
            }
