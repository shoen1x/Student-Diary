            ...
            for (int i = 0; i < N; i++) {
                ...
                switch (mAttrMap.get(attr)) {
                    ...
                    case 13:
                        ...
                        break;
                    case 14:
                        boolean unused10 = c.mVisibility = a.getBoolean(attr, c.mVisibility);
                        break;
                    case 15:
                        float unused11 = c.mScaleY = a.getFloat(attr, c.mScaleY);
                        break;
                    case 16:
                        float unused12 = c.mTranslationX = a.getDimension(attr, c.mTranslationX);
                        break;
                    case 17:
                        float unused13 = c.mTranslationY = a.getDimension(attr, c.mTranslationY);
                        break;
                    case 18:
                        if (Build.VERSION.SDK_INT < 21) {
                            break;
                        } else {
                            float unused14 = c.mTranslationZ = a.getDimension(attr, c.mTranslationZ);
                            break;
                        }
                    case 19:
                        float unused15 = c.mProgress = a.getFloat(attr, c.mProgress);
                        break;
                    default:
