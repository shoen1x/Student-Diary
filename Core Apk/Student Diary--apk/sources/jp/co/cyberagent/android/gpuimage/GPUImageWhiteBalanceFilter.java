...
public class GPUImageWhiteBalanceFilter extends GPUImageFilter {
    ...
    public void setTemperature(float temperature) {
        this.mTemperature = temperature;
        setFloat(this.mTemperatureLocation, (float) ((((double) temperature) - 5000.0d) * (temperature < 5000.0f ? 4.0E-4d : 6.0E-5d)));
    }

    public void setTint(float tint) {
        this.mTint = tint;
        setFloat(this.mTintLocation, (float) (((double) tint) / 100.0d));
    }
}
