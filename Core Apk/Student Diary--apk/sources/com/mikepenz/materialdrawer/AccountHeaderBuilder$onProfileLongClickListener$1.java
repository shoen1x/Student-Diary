...
final class AccountHeaderBuilder$onProfileLongClickListener$1 implements View.OnLongClickListener {
    final /* synthetic */ AccountHeaderBuilder this$0;

    AccountHeaderBuilder$onProfileLongClickListener$1(AccountHeaderBuilder accountHeaderBuilder) {
    ...
    public final boolean onLongClick(View v) {
        ...
        if (tag != null) {
            ...
            return onAccountHeaderProfileImageListener$materialdrawer.onProfileImageLongClick(v, profile, false);
        }
