...
public final class SelectExtension$selectByIdentifier$1 implements AdapterPredicate<Item> {
    ...
    SelectExtension$selectByIdentifier$1(SelectExtension $outer, long $captured_local_variable$1, boolean $captured_local_variable$2, boolean $captured_local_variable$3) {
        this.this$0 = $outer;
