...
public class MaterialComponentsViewInflater extends AppCompatViewInflater {
    ...
    public boolean shouldInflateAppCompatButton(Context context, AttributeSet attrs) {
        ...
        if (floatingToolbarItemBackgroundResId == -1) {
            floatingToolbarItemBackgroundResId = context.getResources().getIdentifier("floatingToolbarItemBackgroundDrawable", "^attr-private", SystemMediaRouteProvider.PACKAGE_NAME);
        }
