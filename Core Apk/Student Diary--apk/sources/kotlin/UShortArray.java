...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static boolean m363equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual((Object) sArr, (Object) ((UShortArray) obj).m374unboximpl());
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m373containsxj2QHRw(((UShort) obj).m357unboximpl());
        }
        return false;
    }
    ...
    public static short[] m360constructorimpl(short[] storage2) {
        Intrinsics.checkParameterIsNotNull(storage2, "storage");
        return storage2;
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static short[] m359constructorimpl(int size) {
        return m360constructorimpl(new short[size]);
    }

    /* renamed from: get-impl  reason: not valid java name */
    public static final short m365getimpl(short[] $this, int index) {
        return UShort.m316constructorimpl($this[index]);
    }

    /* renamed from: set-01HTLdE  reason: not valid java name */
    public static final void m370set01HTLdE(short[] $this, int index, short value) {
        $this[index] = value;
    }

    /* renamed from: getSize-impl  reason: not valid java name */
    public static int m366getSizeimpl(short[] $this) {
        return $this.length;
    }

    /* renamed from: iterator-impl  reason: not valid java name */
    public static UShortIterator m369iteratorimpl(short[] $this) {
    ...
    /* renamed from: contains-xj2QHRw  reason: not valid java name */
    public static boolean m361containsxj2QHRw(short[] $this, short element) {
        return ArraysKt.contains($this, element);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m362containsAllimpl(short[] $this, Collection<UShort> elements) {
        Object it;
        ...
        for (Object it2 : $this$all$iv) {
            if (!(it2 instanceof UShort) || !ArraysKt.contains($this, ((UShort) it2).m357unboximpl())) {
                it = null;
                continue;
            } else {
                it = 1;
    ...
    public static boolean m368isEmptyimpl(short[] $this) {
