...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m942containsWZ4Q5Ns(((UInt) comparable).m193unboximpl());
    }

    public UInt getStart() {
        return UInt.m144boximpl(getFirst());
    }

    public UInt getEndInclusive() {
        return UInt.m144boximpl(getLast());
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m942containsWZ4Q5Ns(int value) {
    ...
    public String toString() {
        return UInt.m187toStringimpl(getFirst()) + ".." + UInt.m187toStringimpl(getLast());
    }
