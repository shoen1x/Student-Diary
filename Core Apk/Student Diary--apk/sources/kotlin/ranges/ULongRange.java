...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m944containsVKZWuLQ(((ULong) comparable).m262unboximpl());
    }

    public ULong getStart() {
        return ULong.m213boximpl(getFirst());
    }

    public ULong getEndInclusive() {
        return ULong.m213boximpl(getLast());
    }

    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public boolean m944containsVKZWuLQ(long value) {
    ...
    public int hashCode() {
        ...
        return (((int) ULong.m219constructorimpl(getFirst() ^ ULong.m219constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m219constructorimpl(getLast() ^ ULong.m219constructorimpl(getLast() >>> 32)));
    }

    public String toString() {
        return ULong.m256toStringimpl(getFirst()) + ".." + ULong.m256toStringimpl(getLast());
    }
