...
public final class TestClock extends AbstractLongClock {
    ...
    public final void m58plusAssignLRDsOJo(double duration) {
        long newReading;
        double delta = Duration.m43toDoubleimpl(duration, getUnit());
    ...
    private final void m57overflowLRDsOJo(double duration) {
        throw new IllegalStateException("TestClock will overflow if its reading " + this.reading + "ns is advanced by " + Duration.m49toStringimpl(duration) + '.');
    }
}
