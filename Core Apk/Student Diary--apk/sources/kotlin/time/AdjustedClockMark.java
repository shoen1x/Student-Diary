...
final class AdjustedClockMark extends ClockMark {
    ...
    public double elapsedNow() {
        return Duration.m34minusLRDsOJo(this.mark.elapsedNow(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public ClockMark m6plusLRDsOJo(double duration) {
        return new AdjustedClockMark(this.mark, Duration.m35plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
